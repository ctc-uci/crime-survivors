...
const temp = (
  <div className="">
    <div className="general-guides-container">
      <h1 className="general-guides-title">General Guides</h1>
      <p className="general-guides-subtitle">
        Crime victims often do not know where to turn in the aftermath of crime.
        The resources and referrals provided herein can be the first step for victims and their
        ...
        {guideBoxData.map((guide) => (
          <div>
            <div className="guide-box-img-container">
              <img className="no-margin guide-icon" src={guide.svg} alt={guide.svg} />
            </div>
